...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <title>Smart Call History</title>
  </head>
  <!--Presentors:
  ...
  <body>
    <div class="wrapper">
      <nav>
        ...
        <div class="sidebar" id="sidebar">
          ...
          />
            ...
            <hr />
            <a href = "history-smart.php"><li class = "active">
        ...
        <div class = "">
            <div class = active-patients>
                ...
                <table>                  
                    ...
                    <tbody>                     
                    <?php
                        $query = "SELECT * FROM tbl_228_smartcalls_history WHERE smart_type != 'Voice Call'";            
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>
                            <button type='button' class='btn btn-secondary'>Confirmed</button>
                            </td>
                          </div>";
                            echo "</tr>";
                        }
      ...
      <div class="mobile-table-area" style="display:none;">
        <h2><img src="svg/arrow-left.svg">Smart Call History</h2>
