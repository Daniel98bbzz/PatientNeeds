...
if(isset($_GET['save_changes'])) {
  ...
  $patient_bed = mysqli_real_escape_string($connection, $_GET['patient_bed']);
    ...
    $query = "UPDATE tbl_228_patients SET 
...
<body>
  <div class="wrapper">
    ...
    <main class="main-content">
      <h1 class=headlines>Patient Profile</h1>
      <div class="utilities">
        <button type="button" class="icon-button3">
          <span class="material-icons">notifications</span>
          <span class="icon-button__badge">14</span>
    ...
    <form id="editForm" method="GET" action="patient.php">
        ...
        <div class="info-card-body">
            ...
            <button id="editButton" type="button">Edit Details</button>
            <button id="saveButton" type="submit" style="display: none;">Save Changes</button>
            <button type='button' class='btn btn-primary delete-btn' data-patient-id='<?php echo $patient['patient_id']; ?>'>Delete Patient</button>
            </div>
        </div>
    </form>
</div>
...
$(document).ready(function(){
    var fields = ["initials", "gender", "risk", "age", "department", "room", "bed"];

    $("#editButton").click(function() {
        fields.forEach(function(field) {
            var currentValue = $("#" + field).text();
            $("#" + field).html('<input name="patient_'+ field +'" type="text" value="'+ currentValue +'" />');
        });
