...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <title>Voice Call History</title>
  </head>
  <!--Presentors:
      ...
      <nav>
        ...
        <div class="sidebar" id="sidebar">
          ...
          />
            ...
            <a href = "history-calls.php"><li class = "active">
                ...
                <table>                   
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>
                            <button type='button' class='btn btn-secondary'>Answered</button>
                            </td>
                          </div>";
                            echo "</tr>";
                        }
