...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <title>Active Smart Calls</title>
  </head>
  <!--Presentors:
  ...
  <body>
    <div class="wrapper">
      <nav>
        ...
        <div class="sidebar" id="sidebar">
          ...
          <li class="galit-li">
            ...
            <a href = "active-smart.php"><li class = "active">
        ...
        <div class = "">
            <div class = active-patients>
                <div class = "active-helpers">
                    ...
                    <input class ="search-bar" type = "text" placeholder="Search Smart Calls">
                ...
                <table>
                    ...
                    <?php
                        $query = "SELECT * FROM tbl_228_smartcalls WHERE smart_type != 'Voice Call'";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>
                            <button type='button' class='btn btn-primary confirm-btn' data-smart-id='". $row["smart_id"]. "'>Confirm</button>
                            </td>
                          </div>";
                            echo "</tr>";
                        }
      ...
      <div class="mobile-table-area" style="display:none;">
        <h2><img src="svg/arrow-left.svg">Active Smart Calls</h2>
    ...
    <script src = "js/transfer_call.js"></script>
