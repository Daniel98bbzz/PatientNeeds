...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <title>Active Voice Calls</title>
  </head>
  <!--Presentors:
    ...
    <div class="wrapper">
      <nav>
        ...
        <div class="sidebar" id="sidebar">          
          ...
          <a href = "active-calls.php"><li class = "active">
                ...
                <table>                    
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td>
                            <button type='button' class='btn btn-primary confirm-btn' data-smart-id='". $row["smart_id"]. "'>Answer</button>
                            </td>
                          </div>";
                            echo "</tr>";
                        }
      ...
      <div class="mobile-table-area" style="display:none;">
        <h2><img src="svg/arrow-left.svg">Active Voice Calls</h2>
